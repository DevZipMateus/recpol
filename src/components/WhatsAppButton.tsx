...
const WhatsAppButton = () => {
  const handleClick = (e: React.MouseEvent) => {
    e.preventDefault();
    gtagSendEvent('https://wa.me/5511947442886');
  };
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className={cn(
        "fixed bottom-6 right-6 z-50 bg-green-500 text-white rounded-full",
    ...
    >
      ...
      <span className="text-sm font-medium hidden sm:block">Fale conosco no WhatsApp</span>
    </a>
  );
};
